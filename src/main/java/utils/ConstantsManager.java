...
public class ConstantsManager {
    ...
    private ConstantsManager() {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(Constants.class);

            Unmarshaller unmarshaller = context.createUnmarshaller();

            ClassLoader loader = ConstantsManager.class.getClassLoader();
            File f = new File(
                    Objects.requireNonNull(
                            loader.getResource("constants.xml")).getFile()
            );
